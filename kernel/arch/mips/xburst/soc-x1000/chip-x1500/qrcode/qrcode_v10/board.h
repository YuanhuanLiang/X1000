...
#define SPI0_CHIP_SELECT0               GPIO_PA(21)
...
#else
#define GPIO_USB_DETE                   GPIO_PB(21)
#define GPIO_USB_DETE_LEVEL             LOW_ENABLE
#endif
...
#define GPIO_USB_SWITCH                 (-1)
#define GPIO_USB_SWITCH_LEVEL           HIGH_ENABLE

#define GPIO_USB_REMOTE_WKUP_DETE       (-1)
...
#define CAMERA_SENSOR_RESET             (-1)
#define CAMERA_FRONT_SENSOR_PWDN        GPIO_PC(24)
#define CAMERA_VDD_EN                   (-1)
#endif

/*
 * EFUSE
 */
#define GPIO_EFUSE_VDDQ                 GPIO_PB(0)  /* EFUSE must be -ENODEV or a gpio */
