...
__initdata int gpio_ss_table[][2] = {
    ...
    {32*0+20,   GSS_OUTPUT_LOW   },    /* CPU_RST_FP */
    {32*0+21,   GSS_IGNORE   },        /* SSIO_CE1 */
    ...
    /* GPIO Group - B */
    {32*1+0,    GSS_INPUT_NOPULL },    /* MOTO_DIRECTION */
    {32*1+1,    GSS_INPUT_NOPULL },    /* MOTO_DRIVER_EN */
    {32*1+2,    GSS_OUTPUT_LOW   },    /* FP_INT_CPU */
    {32*1+3,    GSS_INPUT_NOPULL },    /* LOCK_SWS */
    {32*1+4,    GSS_OUTPUT_LOW   },    /* CPU_PD_CARD */
    {32*1+5,    GSS_INPUT_NOPULL },    /* F_SHUTDOWN_N */
    {32*1+6,    GSS_OUTPUT_LOW   },    /* LED_RAW_D4 */
    {32*1+7,    GSS_OUTPUT_LOW   },    /* CARD_INT_CPU */
    {32*1+8,    GSS_OUTPUT_LOW   },    /* LED_RAW_D1*/
    {32*1+9,    GSS_OUTPUT_LOW   },    /* LED_RAW_D3 */
    {32*1+10,   GSS_IGNORE       },    /* CPU_INT_TOUCH */
    {32*1+11,   GSS_OUTPUT_LOW   },    /* LED_COL_D3 */
    {32*1+12,   GSS_OUTPUT_HIGH  },    /* SLCD_VDD_EN */
    {32*1+13,   GSS_OUTPUT_LOW   },    /* LED_RAW_D2 */
    {32*1+14,   GSS_OUTPUT_LOW   },    /* SLCD_PWR_EN */
    {32*1+15,   GSS_OUTPUT_LOW   },    /* LED_COL_D1 */
    {32*1+16,   GSS_OUTPUT_LOW   },    /* SLCD_RD */
    {32*1+17,   GSS_OUTPUT_LOW   },    /* SLCD_WR */
    {32*1+18,   GSS_OUTPUT_LOW   },    /* SLCD_CE */
    {32*1+19,   GSS_OUTPUT_LOW   },    /* LED_COL_D2 */
    {32*1+20,   GSS_OUTPUT_LOW   },    /* SLCD_DC */
    {32*1+21,   GSS_OUTPUT_LOW   },    /* CPU_RST_CARD */
    {32*1+22,   GSS_IGNORE       },    /* SENSOR_PWR_EN */
    ...
    {32*1+27,   GSS_OUTPUT_LOW   },    /* CAM_AVDD_EN */
    ...
    {32*2+22,   GSS_OUTPUT_LOW   },    /* CIM_PWDN */
...
#endif
    {32*2+26,   GSS_INPUT_NOPULL },    /* LOCK_SWK */
    {32*2+27,   GSS_INPUT_NOPULL },    /* LOCK_SWF */
    {32*2+28,   GSS_INPUT_PULL   },    /*  */
    {32*2+29,   GSS_INPUT_PULL   },    /*  */
