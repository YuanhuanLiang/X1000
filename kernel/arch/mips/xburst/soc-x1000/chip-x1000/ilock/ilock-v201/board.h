...
#define GPIO_BL_PWR_EN                      GPIO_PB(14)
#define GPIO_LCD_BACKLIGHT                  GPIO_PD(05)
#define GPIO_LCD_VDD_EN                     GPIO_PB(12)
#define GPIO_LCD_PWM                        (-1)
#endif
