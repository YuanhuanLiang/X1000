...
#if (defined CONFIG_SERIAL_JZ47XX_UART0_PC || defined CONFIG_SERIAL_JZ47XX_UART0_PC_NO_CTSRTS)

struct uart_wakeup_pin uart0_wakeup_pin = {
        .num          = GPIO_PC(10),
        .trigger_edge = IRQF_TRIGGER_FALLING,
        .def_func     = GPIO_FUNC_0,
};

struct jz_uart_platform_data jz_uart0_platform_data = {
        .wakeup_pin = &uart0_wakeup_pin,
};
...
#if (defined CONFIG_SERIAL_JZ47XX_UART1_PA || defined CONFIG_SERIAL_JZ47XX_UART1_PA_NO_CTSRTS)
struct uart_wakeup_pin uart1_wakeup_pin = {
        .num          = GPIO_PA(04),
        .trigger_edge = IRQF_TRIGGER_FALLING,
        .def_func     = GPIO_FUNC_2,
};

struct jz_uart_platform_data jz_uart1_platform_data = {
        .wakeup_pin = &uart1_wakeup_pin,
};

#elif (defined CONFIG_SERIAL_JZ47XX_UART1_PD || defined CONFIG_SERIAL_JZ47XX_UART1_PD_NO_CTSRTS)
...
struct uart_wakeup_pin uart2_wakeup_pin = {
        .num          = GPIO_PA(02),
        .trigger_edge = IRQF_TRIGGER_FALLING,
        .def_func     = GPIO_FUNC_2,
};
...
struct jz_uart_platform_data jz_uart2_platform_data = {
        .wakeup_pin = &uart2_wakeup_pin,
};

#elif (defined CONFIG_SERIAL_JZ47XX_UART2_PD)
struct uart_wakeup_pin uart2_wakeup_pin = {
        .num          = GPIO_PD(5),
        .trigger_edge = IRQF_TRIGGER_FALLING,
        .def_func     = GPIO_FUNC_0,
...
struct pwm_battery_platform_data pwm_battery_platform_data = {
    ...
    .pwm_ref_voltage            = 3260,  /* unit mV: VDDIO voltage on Board */
