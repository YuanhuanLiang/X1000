...
#ifdef CONFIG_JZ_SCC
#define SC_RESET_PIN                 GPIO_PB(0)
#define SC_POWER_PIN                 (-1)
#endif /* CONFIG_JZ_SCC */

#ifdef CONFIG_ESP8089
#define ESP8089_CHIP_EN             GPIO_PC(20)
#define ESP8089_PWR_EN              GPIO_PB(21)
#define ESP8089_PWR_EN_LEVEL        1
#endif

#ifdef CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5
#define CYTTSP5_I2C_IRQ_GPIO            GPIO_PA(17)
#define CYTTSP5_I2C_RST_GPIO            GPIO_PA(18)
#endif

#ifdef CONFIG_IR_EM20918
#define EM20918_INT_PIN                 GPIO_PA(17)
#endif
