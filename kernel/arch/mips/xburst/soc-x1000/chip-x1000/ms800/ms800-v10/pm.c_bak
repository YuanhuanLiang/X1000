...
__initdata int gpio_ss_table[][2] = {
    ...
    {32*0+4,    GSS_OUTPUT_HIGH  },    /* SLCD_D4 */ // SYS_LED --change by liangyh
    {32*0+5,    GSS_OUTPUT_HIGH  },    /* SLCD_D5 */ // RFS_KEY --change by liangyh
    ...
    {32*1+21,   GSS_OUTPUT_HIGH  },    /* FUEL_GAUGE */ // PS_EN
    ...
    {32*2+13,   GSS_OUTPUT_HIGH   },    /* CPU_PWRON_2G */ 
    ...
    {32*2+24,   GSS_OUTPUT_LOW },    /* MH_PWR_EN */ // change by liangyh 
