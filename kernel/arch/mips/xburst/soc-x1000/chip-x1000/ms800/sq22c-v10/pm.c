...
__initdata int gpio_ss_table[][2] = {
    ...
    {32*0+20,   GSS_OUTPUT_HIGH  },    /* CIM_PWDN */
    ...
    /* GPIO Group - B */
    {32*1+0,    GSS_OUTPUT_LOW   },    /* SCAN_KEY */
    {32*1+1,    GSS_OUTPUT_LOW   },    /* NULL */
    {32*1+2,    GSS_OUTPUT_LOW   },    /* NULL */
    {32*1+3,    GSS_INPUT_PULL   },    /* USB_DETECT */
    {32*1+4,    GSS_OUTPUT_LOW   },    /* NULL */
    {32*1+5,    GSS_OUTPUT_LOW   },    /* CIM_P-LED */
    {32*1+6,    GSS_OUTPUT_LOW   },    /* CIM_F_LED */
    {32*1+7,    GSS_INPUT_PULL   },    /* KEY_COL0 */
    {32*1+8,    GSS_INPUT_PULL   },    /* KEY_COL1 */
    {32*1+9,    GSS_INPUT_PULL   },    /* KEY_COL2 */
    {32*1+10,   GSS_IGNORE       },    /* KEY_ROW0 */
    {32*1+11,   GSS_IGNORE       },    /* KEY_ROW1 */
    {32*1+12,   GSS_IGNORE       },    /* KEY_ROW2 */
    {32*1+13,   GSS_IGNORE       },    /* KEY_ROW3 */
    {32*1+14,   GSS_IGNORE       },    /* KEY_ROW4 */
    {32*1+15,   GSS_OUTPUT_LOW   },    /* KEY_LED */
    ...
    {32*1+21,   GSS_INPUT_PULL   },    /* FUEL_GAUGE */
    {32*1+22,   GSS_IGNORE       },    /* MCU_INT_CPU */
    {32*1+23,   GSS_OUTPUT_LOW   },    /* SMB0_SCK */
    {32*1+24,   GSS_OUTPUT_LOW   },    /* SMB0_SDA */
    {32*1+25,   GSS_OUTPUT_LOW   },    /* DRVVBUS */
    {32*1+26,   GSS_INPUT_NOPULL },    /* CHR_FINISH */
    ...
    {32*2+6,    GSS_IGNORE       },    /* MCU_BUSY_OUT */
    {32*2+7,    GSS_IGNORE       },    /* CPU_RST_MCU */
    {32*2+8,    GSS_OUTPUT_LOW   },    /* NULL */
    {32*2+9,    GSS_INPUT_PULL   },    /* CPU_INT_MCU */
    {32*2+10,   GSS_INPUT_PULL   },    /* UART0_RXD */
    {32*2+11,   GSS_INPUT_PULL   },    /* UART0_TXD */
    {32*2+12,   GSS_INPUT_PULL   },    /* 2G_STATUS */
    {32*2+13,   GSS_IGNORE       },    /* CPU_PWRON_2G */
    ...
    /*GPIO Group -D */
    {32*3+0,    GSS_INPUT_NOPULL },    /* LED_DATA */
    {32*3+1,    GSS_INPUT_NOPULL },    /* CPU_EN_PWRB2 */
    {32*3+2,    GSS_IGNORE       },    /* UART1_RXD */
    {32*3+3,    GSS_IGNORE       },    /* UART1_TXD */
    {32*3+4,    GSS_OUTPUT_HIGH  },    /* LED_STB */
    {32*3+5,    GSS_OUTPUT_HIGH  },    /* LED_CLK */
    /* GPIO Group Set End */
