...
#if defined (CONFIG_CC1101_915M)
	{
        .modalias        = "cc1101", /*需要绑定的驱动的名字*/
        .mode            = SPI_MODE_0,
        .max_speed_hz    = 10000000,
        .bus_num         = 0,
        .chip_select     = 0,
        .controller_data = NULL,/* cs for spi gpio */
        .platform_data   = NULL,//&spi_cc1101_pdata,
    }
#elif defined(CONFIG_FINGERPRINT_MICROARRAY)
    {
...
#endif /* CONFIG_FINGERPRINT_MICROARRAY */
