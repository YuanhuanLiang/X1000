...
#define FRONT_CAMERA_SENSOR_RESET                 GPIO_PD(5)//GPIO_PA(21) -- liangyh
#define FRONT_CAMERA_SENSOR_PWDN                  GPIO_PD(4)//GPIO_PA(20) -- liangyh
#define FRONT_CAMERA_VDD_EN                       GPIO_PC(18)
#define FRONT_CAMERA_SENSOR_RESET_LEVEL           0
#define FRONT_CAMERA_SENSOR_PWDN_LEVEL            0
#define FRONT_CAMERA_VDD_EN_LEVEL                 1//0 -- liangyh
...
#define GPIO_LCD_BACKLIGHT                  GPIO_PB(0)
#define GPIO_LCD_VDD_EN                     GPIO_PB(1)
#define GPIO_LCD_PWM                        (-1)
...
#define FINGERPRINT_POWER_EN                (-1)//GPIO_PB(22)
#define FINGERPRINT_POWER_2V8               (-1)
#define FINGERPRINT_POWER_1V8               (-1)
#define FINGERPRINT_INT                     (-1)//GPIO_PB(02)
