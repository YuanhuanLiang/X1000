...
#include "sa_keypad_ring.h"
#include "sa_earpods_wire.h"
...
#ifdef CONFIG_SA_KEYBOARD_RING
static struct ring_keys_button sa_ring_key_buttons[] = {
	{
		.code		= KEY_LEFT,
		.desc		= "ring left",
        .direction  = RING_COUNTER_CLOCKWISE,
	}, 
    {
		.code		= KEY_RIGHT,
		.desc		= "ring right",
...
static struct ring_keys_platform_data sa_ring_key_button_data = {
	.buttons	= sa_ring_key_buttons,
	.nbuttons	= ARRAY_SIZE(sa_ring_key_buttons),
    .timer_debounce = 100,
    .ring1_gpio = ENCODE0_RING_PIN1,
    .ring2_gpio = ENCODE0_RING_PIN2,
};

static struct platform_device sa_ring_button_device = {
	.name	        = "sa-ring-keys",
	.id		        = -1,
	.num_resources	= 0,
	.dev		    = {
		.platform_data	= &sa_ring_key_button_data,
	},
};
#endif


#ifdef CONFIG_SA_EARPODS_WIRE
static struct earpods_wire_platform_data sa_earpods_wire_platdata = {
    .desc = "earpods_wire",
    .active_low = 0,
    .gpio = 0,
};

static struct platform_device sa_earpods_wire_device = {
    .name   = "earpods_wire",
    .id     = -1,
    .dev    = {
       .platform_data = &sa_earpods_wire_platdata,
    },
};	
#endif
...
#ifdef CONFIG_BEKEN_BK3515_RFKILL
	DEF_DEVICE(&bt_power_device,0,0),
#endif
...
#if defined(CONFIG_SND_ASOC_JZ_AIC_V12)
	DEF_DEVICE(&snd_idriver_device, NULL, 0),
	DEF_DEVICE(&codec_pcm5102, NULL, 0),
#endif
#if defined(CONFIG_SND_ASOC_INGENIC_SA_SWITCH)
    DEF_DEVICE(&sa_sound_swith_device, NULL, 0),
#endif
#if defined(CONFIG_REGULATOR_GPIO)
    DEF_DEVICE(&device_gpio_regulators, NULL, 0),
#endif
...
#ifdef CONFIG_SA_KEYBOARD_RING
	DEF_DEVICE(&sa_ring_button_device, 0, 0),
#endif

#ifdef CONFIG_SA_EARPODS_WIRE
	DEF_DEVICE(&sa_earpods_wire_device, 0, 0),
#endif
