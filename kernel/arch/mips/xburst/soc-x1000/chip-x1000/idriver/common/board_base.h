...
extern struct platform_device oled_rgs15128128wr000_device;
#endif
...
extern struct platform_device snd_idriver_device;
extern struct platform_device codec_pcm5102;
#endif
#if defined(CONFIG_SND_ASOC_INGENIC_SA_SWITCH)
extern struct platform_device sa_sound_swith_device;
#endif
extern struct platform_device comip_snd_soc_device;
#if defined(CONFIG_SND_ASOC_INGENIC_SA_SETTING)
extern struct platform_device sa_sound_setting_device;
#endif
#endif
