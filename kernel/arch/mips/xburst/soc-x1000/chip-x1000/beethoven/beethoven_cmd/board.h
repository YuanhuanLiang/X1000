...
#define GPIO_VOLUMEDOWN_KEY             GPIO_PA(0)
#define ACTIVE_LOW_VOLUMEDOWN           1

#define GPIO_MENU_KEY                   GPIO_PA(6)
#define ACTIVE_LOW_MENU                 1

#define GPIO_PLAY_KEY                   GPIO_PB(20)
#define ACTIVE_LOW_PLAY                 1

#define GPIO_VIDEO_NEXT_KEY             GPIO_PA(2)
#define ACTIVE_LOW_VIDEO_NEXT           1

#define GPIO_VIDEO_PREV_KEY             GPIO_PA(3)
...
#define GPIO_AKM4951_SPEAKER_EN         GPIO_PB(7)       /* amp shutdown pin */
#define GPIO_AKM4951_SPEAKER_EN_LEVEL   0
...
#define BK9522_SDA_GPIO                 GPIO_PD(1)
#define BK9522_SCK_GPIO                 GPIO_PD(0)
#endif
