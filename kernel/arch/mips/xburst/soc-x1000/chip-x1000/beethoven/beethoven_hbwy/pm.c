...
__initdata int gpio_ss_table[][2] = {
	...
	{32*0+8,    GSS_INPUT_PULL  },    /* NULL */
	{32*0+9,    GSS_INPUT_PULL  },    /* NULL */
	{32*0+10,   GSS_INPUT_PULL  },    /* LCD_EN */
	{32*0+11,   GSS_INPUT_PULL  },    /* NULL */
	{32*0+12,   GSS_INPUT_PULL  },    /* NULL */
	{32*0+13,   GSS_INPUT_NOPULL},    /* BAT_IO3 */
	{32*0+14,   GSS_INPUT_NOPULL},    /* BAT_IO2 */
	{32*0+15,   GSS_INPUT_NOPULL},    /* BAT_IO1 */
	{32*0+16,   GSS_INPUT_PULL  },    /* NULL */
	{32*0+17,   GSS_OUTPUT_LOW  },    /* BAT_ACTIVE */
	{32*0+18,   GSS_INPUT_PULL  },    /* NULL */
	{32*0+19,   GSS_INPUT_PULL  },    /* W IFI_PW _EN */
	...
	{32*1+5,    GSS_INPUT_PULL  },    /* LINEIN_DET */
	{32*1+6,    GSS_OUTPUT_LOW  },    /* PW M0 */
	{32*1+7,    GSS_OUTPUT_LOW  },    /* AMP_BOOST_OUT */
	{32*1+8,    GSS_INPUT_PULL  },    /* NULL*/
	{32*1+9,    GSS_OUTPUT_LOW  },    /* SHUTDOW N */
	{32*1+10,   GSS_INPUT_PULL  },    /* AMP_ALC */
	{32*1+11,   GSS_INPUT_PULL  },    /* MUTE */
	{32*1+12,   GSS_INPUT_PULL  },    /* NULL */
	{32*1+13,   GSS_INPUT_PULL  },    /* AMP_VSEL */
	{32*1+14,   GSS_INPUT_PULL  },    /* NULL */
	{32*1+15,   GSS_INPUT_PULL  },    /* NULL */
	{32*1+16,   GSS_INPUT_PULL  },    /* SLCD_RD */
	{32*1+17,   GSS_INPUT_PULL  },    /* SLCD_WR */
	{32*1+18,   GSS_INPUT_PULL  },    /* SLCD_CE */
	{32*1+19,   GSS_OUTPUT_LOW  },    /* LCD_RESET */
	...
	{32*2+21,   GSS_OUTPUT_LOW  },     /* FM_AUX_SEL */
	{32*2+22,   GSS_INPUT_PULL  },     /* PW REN_FM */
	{32*2+23,   GSS_INPUT_PULL  },     /* USB_DETECT */
	{32*2+24,   GSS_INPUT_PULL  },     /* PW M4 */
	{32*2+25,   GSS_INPUT_PULL  },     /* PW M3 */
	{32*2+26,   GSS_INPUT_PULL  },     /* PW M1 */
	{32*2+27,   GSS_INPUT_PULL  },     /* PW M2 */
	{32*2+31,   GSS_INPUT_PULL  },     /* JTAG/UART2 */

	/*GPIO Group -D */
    {32*3+0,    GSS_OUTPUT_LOW  },     /* CODEC_PDN*/
    {32*3+1,    GSS_INPUT_PULL  },     /* MCU_PW R_EN*/
    {32*3+2,    GSS_INPUT_PULL  },     /* UART1_MCU_RXD */
    {32*3+3,    GSS_INPUT_PULL  },     /* UART1_MCU_TXD */
	{32*3+4,    GSS_INPUT_PULL  },     /* X1000_W KUP_MCU */
	{32*3+5,    GSS_INPUT_PULL  },     /* SD_CD_N */
