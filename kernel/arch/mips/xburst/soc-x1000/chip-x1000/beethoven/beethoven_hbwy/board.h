...
#define GPIO_MENU_KEY                   GPIO_PA(9)
#define ACTIVE_LOW_MENU                 1

#define GPIO_PLAY_KEY                   GPIO_PA(5)
#define ACTIVE_LOW_PLAY                 1

#define GPIO_VIDEO_NEXT_KEY             GPIO_PA(7)
#define ACTIVE_LOW_VIDEO_NEXT           1

#define GPIO_VIDEO_PREV_KEY             GPIO_PA(8)
#define ACTIVE_LOW_VIDEO_PREV           1

#define GPIO_VOLUMEUP_KEY               GPIO_PB(20)
...
#define GPIO_SPEAKER_MUTE_EN_LEVEL  0

#define GPIO_SPEAKER_EN    GPIO_PB(7)         /*speaker enable gpio*/
...
#define GPIO_LINEIN_DETECT GPIO_PB(11)
#define GPIO_LINEIN_INSERT_LEVEL 0
#define GPIO_LINEIN_AUX_SEL GPIO_PC(23)
#define GPIO_LINEIN_AUX_SEL_LEVEL   0
