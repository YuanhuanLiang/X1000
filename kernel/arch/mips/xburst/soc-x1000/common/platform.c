...
#ifdef CONFIG_SERIAL_JZ47XX_UART0_PC
        UART0_PORTC,
#endif
#ifdef CONFIG_SERIAL_JZ47XX_UART0_PC_NO_CTSRTS
        UART0_PORTC_NO_CTSRTS,
#endif

#ifdef CONFIG_SERIAL_JZ47XX_UART1_PA
        UART1_PORTA,
#endif
#ifdef CONFIG_SERIAL_JZ47XX_UART1_PA_NO_CTSRTS
        UART1_PORTA_NO_CTSRTS,
#endif
#ifdef CONFIG_SERIAL_JZ47XX_UART1_PD
        UART1_PORTD,
#endif
#ifdef CONFIG_SERIAL_JZ47XX_UART1_PD_NO_CTSRTS
        UART1_PORTD_NO_CTSRTS,
#endif
...
#ifdef CONFIG_SND_ASOC_JZ_I2S_EXTCODEC
        I2S_PORTB,
#endif
...
struct resource jz_aes_res[] = {
    {
        .start = SECURITY_IOBASE,
        .end = SECURITY_IOBASE + 0x100,
        .flags = IORESOURCE_MEM,
    },
    {
        .start = IRQ_AES,
...
#ifdef CONFIG_JZ_SCC
struct resource jz_scc_resources[] = {
    {
        .start = SCC_IOBASE,
        .end = SCC_IOBASE + 0x20 - 1,
        .flags = IORESOURCE_MEM,
    }
};

struct platform_device jz_scc_device = {
    .name = "jz-scc",
    .id = -1,
    .num_resources = ARRAY_SIZE(jz_scc_resources),
    .resource = jz_scc_resources,
};
#endif /* CONFIG_JZ_SCC */
