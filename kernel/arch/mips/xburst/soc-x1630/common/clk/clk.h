...
#define CLK_NAME_VPLL		"vpll"
	CLK_ID_EPLL,
#define CLK_NAME_EPLL		"epll" /*x1630 only*/
...
#define CLK_NAME_AIC		"aic"
	CLK_ID_I2C2,
#define CLK_NAME_I2C2		"i2c2" /* x1630 only */
	CLK_ID_I2C1,
...
#define CLK_NAME_AHB0	        "ahb0"
	CLK_ID_RADIX0,
#define CLK_NAME_RADIX0	        "radix0" /* radix */
	CLK_ID_LDC,
#define CLK_NAME_LDC	        "ldc" /* x1630 only */
	CLK_ID_MSCALER,
#define CLK_NAME_MSCALER	    "mscaler" /* x1630 only */

	CLK_ID_AES,
#define CLK_NAME_AES	        "aes"
	CLK_ID_AHB1,
#define CLK_NAME_AHB1	        "ahb1"
	CLK_ID_GMAC,
#define CLK_NAME_GMAC	        "gmac"
	CLK_ID_IPU,
#define CLK_NAME_IPU	        "ipu"
	CLK_ID_NCU,
#define CLK_NAME_NCU	        "ncu"
	CLK_ID_HELIX0,
#define CLK_NAME_HELIX0	        "helix0"	/*helix*/
	CLK_ID_STOP,
	CLK_ID_INVALID,
	CLK_ID_WDT,
...
enum {	//SHOULD BE CHECKED!!
	...
	CGU_I2S,CGU_MSC1,CGU_MSC0,
	CGU_MACPHY,CGU_VPU, CGU_DDR,
	CGU_MSC_MUX,CGU_LPC,CGU_USB
};
