...
#define USB_REMOTE_WKUP_PIN_SUSPEND	0x0001
#define USB_REMOTE_WKUP_PIN_RESUME	0x0002
/* driver/usb/dwc2/core.c */
extern int usb_remote_wkup_notifier_call_chain(unsigned long val);
#endif
