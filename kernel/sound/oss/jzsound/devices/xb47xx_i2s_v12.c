...
__attribute__((unused)) static struct i2s_device *i2s_get_switch_data(struct snd_switch_data *switch_data)
{
...
static void i2s_set_filter(struct i2s_device *i2s_dev, int mode , uint32_t channels)
{
	...
	switch(cur_codec->record_format) {
		...
		case AFMT_S16_LE:
			if (channels == 1) {
#if (defined(CONFIG_SOC_T10) || defined(CONFIG_SOC_T20) || defined(CONFIG_SOC_T30) || defined(CONFIG_SOC_X1630))
