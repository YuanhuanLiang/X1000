...
__attribute__((unused)) static int icdc_d3_digital_mute(struct snd_soc_dai *dai, int mute)
{
...
__attribute__((weak, alias("board_icodec_mute"))) void board_icodec_mute(int mute) {}
