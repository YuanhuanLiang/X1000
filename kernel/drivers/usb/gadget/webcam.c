...
static const struct UVC_FRAME_UNCOMPRESSED(3) uvc_frame_yuv_480p = {
	...
	.dwDefaultFrameInterval = cpu_to_le32(rate_to_interval(30)),
	.bFrameIntervalType = 3,
	.dwFrameInterval[0] = cpu_to_le32(rate_to_interval(30)),
	.dwFrameInterval[1] = cpu_to_le32(rate_to_interval(25)),
	.dwFrameInterval[2] = cpu_to_le32(rate_to_interval(15)),
};
