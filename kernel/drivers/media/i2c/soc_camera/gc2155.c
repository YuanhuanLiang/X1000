			      ...
			      const struct regval_list *vals)
{
	int ret;
	//u8 my_num;
	//const struct regval_list *vals_old = vals;
...
__attribute__((__unused__)) static int gc2155_enum_frameintervals(struct v4l2_subdev *sd,
 ...
 */
__attribute__((__unused__)) static int gc2155_enum_framesizes(struct v4l2_subdev *sd,
