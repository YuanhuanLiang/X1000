...
#define JZ_RTC_HIBERNATE_UNKNOWN    0xff
#define JZ_RTC_HIBERNATE_APD        0x01
#define JZ_RTC_HIBERNATE_PPR        0x02
#define JZ_RTC_HIBERNATE_ALM        0x03
#define JZ_RTC_HIBERNATE_PIN        0x04
