...
#define SIP_SKB_NUM_8K  10
#define SIP_SKB_NUM_16K  6
#define SIP_SKB_NUM_32K  2
#define SIP_SKB_SPOS_8K  0
#define SIP_SKB_SPOS_16K  10
#define SIP_SKB_SPOS_32K  16

#define SIP_SKB_ARR_NUM 18       /* (SIP_SKB_NUM_8k + SIP_SKB_NUM_16k + SIP_SKB_NUM_32k) */
